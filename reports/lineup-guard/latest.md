...
| FLEX | Tetairoa McMillan (WR, CAR) | 11.8 | CLE | 🟢  |
...
| Player | Proj | Status |
|---|--:|---|
| Rico Dowdle (RB, PIT) | 11.0 | 🟡 Questionable — Toe |
| DJ Moore (WR, BUF) | 10.0 | 🟡 Questionable — Shoulder - AC Joint |
| MarShawn Lloyd (RB, GB) | 9.3 | 🟢  |
| Adonai Mitchell (WR, NYJ) | 8.4 | 🟡 Questionable — Finger |
| Dallas Goedert (TE, PHI) | 0.0 | 🔴 Doubtful — Knee - MCL |
| Alec Pierce (WR, IND) (IR slot) | 0.0 | 🔴 Out — Heel |
